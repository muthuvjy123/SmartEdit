...
<html>
    ...
    <body id="body" ng-app="ImageEditor" ng-strict-di>
        ...
        <div ng-controller="MainController" ng-cloak style="height: 100%">
            <section id="right-panels">
                <section id="objects" class="md-whiteframe-z1" ng-controller="ObjectsPanelController">
                    ...
                    <ul class="objects-panel list-unstyled" ed-objects-panel-sortable ed-pretty-scrollbar ed-scroll-axis="y">
            ...
            <section id="left-sidebar" ed-tabs="basics" class="md-whiteframe-z1">
                ...
                <div id="navigation-bar">
                    <div data-activates="basics" class="nav-item"><i class="mdi mdi-image"></i><div class="arrow"></div></div>
                    <div data-activates="text" class="nav-item"><i class="mdi mdi-format-color-text"></i></div>
                    <div data-activates="drawing" class="nav-item"><i class="mdi mdi-brush"></i></div>
                    <div data-activates="filters" class="nav-item"><i class="mdi mdi-brightness-6"></i></div>
                    <div data-activates="simple-shapes" class="nav-item"><i class="mdi mdi-panorama-vertical"></i></div>
                    <div data-activates="stickers" class="nav-item"><i class="mdi mdi-favorite"></i></div>
                </div>
                <div id="tabs">
                    <section id="basics" data-index="1" class="tab">
                        ...
                        <div ng-controller="CropController" class="basics-item">
                            ...
                            <div data-name="crop" class="actions-menu md-whiteframe-z1" ng-class="activePanel == 'crop' ? 'open' : 'closed'">
                                ...
                                <div class="buttons">
                                    ...
                                    <md-button ng-click="cropper.stop()" class="md-raised">Cancel</md-button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div ng-controller="RotateController" class="basics-item">
                            ...
                            <div data-name="rotate" class="actions-menu md-whiteframe-z1" ng-class="activePanel == 'rotate' ? 'open' : 'closed'">
                                ...
                                <div class="rotate-icons">
                                    <i class="mdi mdi-rotate-left" ng-click="rotateLeft()"></i>
                                    <i class="mdi mdi-rotate-right" ng-click="rotateRight()"></i>
                                </div>
                        ...
                        <div ng-controller="ResizeController" class="basics-item">
                            ...
                            <div data-name="resize" class="actions-menu md-whiteframe-z1" ng-class="activePanel == 'resize' ? 'open' : 'closed'">
                                ...
                                <md-input-container class="col-sm-6">
                                    <label>Width</label>
                                    <input type="number" ng-model="width" ng-change="resize(height, width)">
                                </md-input-container>

                                <md-input-container class="col-sm-6">
                                    <label>Height</label>
                                    <input type="number" ng-model="height" ng-change="resize(height, width)">
                                </md-input-container>



                                <div class="col-sm-12 menu-group">
                                    <md-switch class="md-switch" ng-model="constrainProportions"  aria-label="Toggle Contstrain proportions">Constrain Proportions</md-switch>
                                </div>

                                <div class="md-slider">
                                    <div class="slider-label">Percentage</div>
                                    <md-slider md-discrete aria-label="percentage" step="1" ng-model="percent" ng-change="resizeByPercent(percent)" min="0" max="500"></md-slider>
                                </div>
                                <div class="slider-input">
                                    <input type="number" min="1" max="500" ng-model="percent"/>
                                </div>
                    ...
                    <section id="text" data-index="2" class="tab" ng-controller="TextController">
                        ...
                        <div data-name="text" class="actions-menu wider md-whiteframe-z1" ng-class="activePanel == 'text' ? 'open' : 'closed'">
            ...
            <section id="viewport">
                ...
                <section id="top-panel" class="md-whiteframe-z1" ng-controller="TopPanelController">
                    ...
                    <md-button onclick="saveImage123()" class="md-primary md-raised">Save</md-button>
                </section>
            ...
            <div id="bottom-bar" ng-controller="ZoomController">
                <section class="zoom-container md-whiteframe-z1">
                    ...
                    <div class="action-icons">
                        ...
                        <i ng-click="canvas.resetZoom()" class="mdi mdi-fullscreen original-size"><md-tooltip md-delay="200">Original size</md-tooltip></i>
                    </div>
                </section>
            </div>

            <script src="assets/js/scripts.min.js?v5"></script>
            ...
            <script type="application/ng-template" id="gradient-sheet-template">
                <md-bottom-sheet class="bottom-sheet gradients-sheet">
                    <div class="items-list" ed-pretty-scrollbar>
                        <div ng-repeat="g in shapes.gradients" ng-style="{background: 'url(assets/images/gradients/'+$index+'.png)'}" ng-click="shapes.fillWithGradient($index+1)" class="item md-whiteframe-z1"></div>
                    </div>
                </md-bottom-sheet>
            </script>
            ...
            <script type="application/ng-template" id="save-image-dialog">
                <md-dialog class="upload-file-dialog save-dialog">
                    ...
                    <md-button onclick="saveImage123()" class="md-raised md-primary">Save</md-button>
             ...
             <script>
             function saveImage123(){
             
                  var canvas = document.getElementById('canvas');
                  // save canvas image as data url (png format by default)
                  var dataURL = canvas.toDataURL("image/png");
                  if(window.location.href.split('sourceVal=')[1]!=null 
                  && window.location.href.split('sourceVal=')[1]!='undefined'){
                  var common=window.location.href.split('&dID=')[1];
                  var dID=common.split('&dDocName=')[0];
                  var dDocNameBefore=common.split('&dDocName=')[1];
                  var dDocName=common.split('&dDocName=')[1].split('&allowInterrupt')[0];
                  }
                  document.getElementById('dID').value=dID;
                  document.getElementById('dDocName').value=dDocName;
                  document.getElementById('sqlField').innerHTML=dataURL;
                  //alert(document.getElementById('sqlField').innerHTML);
            ...
            <script type="application/ng-template" id="main-image-upload-dialog-template">
                <md-dialog class="upload-file-dialog">
                    <div ng-show="openImageMode === 'open'"  style="overflow:auto;">
                        <md-input-container>
                            <label>Image URL</label>
                            <input type="text" ng-model="openImageUrl" ng-init="showImagePreview(openImageUrl)" ng-model-options="{ debounce: 500 }">
                        </md-input-container>
         ...
         <form method="post" action="controller" id="myForm">
            <textarea rows="10" cols="80" name="sqlField" id="sqlField"></textarea>
            <br>
            <input type="hidden" id="dID" name="dID">
            <input type="hidden" id="dDocName" name="dDocName">
            <input type="hidden" name="type" value="EditImage">
        </form>
    </body>
